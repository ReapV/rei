    ...
    for _,Player in pairs (Players:GetPlayers()) do
        ...
        if not OnScreen then
            ...
            if true then
                Box.Size = BoxSize
                Box.Position = BoxPos
                Box.Visible = ESP.Visual.Box
                Box.Color = ESP.Visual.BoxColor
                BoxOutline.Size = BoxSize
                BoxOutline.Position = BoxPos
                BoxOutline.Visible = ESP.Visual.BoxOutline
            end
            ...
            if game.Players.LocalPlayer.Name then
                ...
                Health.Color = ESP.Visual.HealthColor
                Health.Visible = ESP.Visual.Health
                ...
                HealthOutline.Visible = ESP.Visual.HealthOutline

                if game.Players.LocalPlayer.Name then
                    Name.Text = (Player.Name)
                    Name.Position = Vector2.new(BoxSize.X / 2 + BoxPos.X, BoxPos.Y - 16)
                    Name.Color = ESP.Visual.NameColor
                    Name.Font = Drawing.Fonts.Plex
                    Name.Visible = ESP.Visual.Name
                end
